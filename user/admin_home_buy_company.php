        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo "Aktien verkaufen" ?></h4>
                </div>
            ...
            <div class="row-fluid sortable">
                ...
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="icon-bar-chart"></i><span class="break"></span>Aktien suchen</h2>

                    </div>
                    <div class="box-content">
                        <?php
                        ?>
                        <form class="form-horizontal" action="buy_company.php" method="post">
