...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title><?php echo "Onlinebanking "; ?></title>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="admin_home.php"><span><img src = "img/img_back.png" width = "50" height = "50"><?php echo "Fido Co Capital" ?></span></a>
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                                    <i class="halflings-icon white user"></i> Benutzerkonto
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="logout.php"><i class="halflings-icon off"></i> Ausloggen</a></li>
                                </ul>
                            </li>
                            <!-- end: User Dropdown -->
                        </ul>
