            ...
            <div class="row-fluid sortable">		
                <div class="box span12">
                    ...
                    <div class="box-header" data-original-title>
                        <h2><i class="icon-bar-chart"></i><span class="break"></span>SEPA Überweisung</h2>
                        ...
                        <form  method="post" class="form-horizontal" action="user_update.php">
                            <fieldset>
                                ...
                                <div id="balance" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead problem" name="balance"  value = "<?php echo $rw['desc1']; ?>" id="typeahead"  data-provide="typeahead" data-items="4" readonly="true" >
                                    </div>
                                </div>  
                                <div id="email1" class="control-group">
                                    <label class="control-label" for="typeahead">IBAN:</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="name"  value = "<?php echo $rw['desc2']; ?>" id="name"  data-provide="typeahead" data-items="4" readonly="true" required >
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="street" value = "<?php echo $rw['desc3']; ?>" id="street"  data-provide="typeahead" data-items="4" readonly="true" required>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        //echo $rw['desc4']; 
                                        echo $a;
                                        ?>" id="phone"  data-provide="typeahead" data-items="4" readonly = "true" required>
