...
if ( ! function_exists( 'stm_get_google_fonts' ) ) {
	function stm_get_google_fonts() {
		$font_options = array();

		$font_options[''] = esc_html__( '--- Default ---', 'consulting' );

		foreach ( stm_google_fonts_array() as $font_key => $font_data ) {
...
if ( ! function_exists( 'stm_get_google_font_variants' ) ) {
	function stm_get_google_font_variants( $font, $variants = array() ) {
		$chosen_variants = array();

		if ( empty( $variants ) ) {

			$stm_custom_fonts = stm_get_google_fonts();
...
if ( ! function_exists( 'stm_google_fonts_array' ) ) {
	function stm_google_fonts_array() {
		...
		return array(
			...
			'Poppins'             => array(
				'label'    => 'Poppins',
				'variants' => array( 'regular', 300, 500, 600, 700 ),
            ...
            'Rubik'           => array(
                'label'    => 'Rubik',
                'variants' => array( '300,300i,400,400i,500,500i,700,700i,900,900i', ),
                'subsets'  => array( 'latin', 'latin-ext', 'cyrillic', 'hebrew'),
                'category' => 'sans-serif',
            ),
			...
			'Ubuntu'                   => array(
				'label'    => 'Ubuntu',
				'variants' => array( '300', '300i', '400', '400i', '500', '500i', '700', '700i' ),
				'subsets'  => array( 'cyrillic', 'cyrillic-ext', 'greek', 'greek-ext', 'latin-ext' ),
				'category' => 'sans-serif',
			),
