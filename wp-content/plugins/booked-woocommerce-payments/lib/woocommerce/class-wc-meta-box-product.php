...
class Booked_WC_Meta_Box_Product_Data {
	...
	public function product_type_options( $options ) {
		$options['booked_appointment'] = array(
			...
			'label' => __('Booked Appointment Service', 'booked-woocommerce-payments'),
			'description' => __('Booked Appointment products are used for Booked Payments.', 'booked-woocommerce-payments'),
			'default' => 'no'
		);
