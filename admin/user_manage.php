                        ...
                        <form method="post" class="form-horizontal" action="user_add.php">
                            <fieldset>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required  onkeypress="return isNumberKey(event);" class="span6 typeahead" name="tel2" value = "<?php echo (isset($_SESSION['tel2']) ? $_SESSION['tel2'] : ''); ?>" id="typeahead"  data-provide="typeahead" data-items="4" required>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="plz" value = "<?php echo (isset($_SESSION['plz']) ? $_SESSION['plz'] : ''); ?>" id="typeahead"  data-provide="typeahead" data-items="4" required>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="ort" value = "<?php echo (isset($_SESSION['ort']) ? $_SESSION['ort'] : ''); ?>" id="typeahead"  data-provide="typeahead" data-items="4" required>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" class="span6 typeahead" name="email2" value = "<?php echo (isset($_SESSION['email2']) ? $_SESSION['email2'] : ''); ?>" id="typeahead"  data-provide="typeahead" data-items="4" required>
                                ...
                                <div id="email1" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="fax" value = "<?php echo (isset($_SESSION['fax']) ? $_SESSION['fax'] : ''); ?>" id="typeahead"  data-provide="typeahead" data-items="4" required>
