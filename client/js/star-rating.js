...
(function (factory) {
    ...
    Rating.prototype = {
        ...
        generateRating: function () {
            ...
            self.$rating.attr('style', 'line-height:70px;');
        ...
        renderClear: function () {
            ...
            return '<div style = "line-height:70px;" class="' + css + '" title="' + self.clearButtonTitle + '">' + self.clearButton + '</div>';
        },
        renderCaption: function () {
            ...
            return '<div style = "line-height:70px;" class="caption">' + html + '</div>';
        },
